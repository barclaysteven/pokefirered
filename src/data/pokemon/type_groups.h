...
static const TypeGroupEncounter gTypeGroupEncounters[] = {
    ...
    {"MAP_SEVEN_ISLAND_TANOBY_RUINS_MONEAN_CHAMBER", ENCOUNTER_LAND, gTypeGroup_Dragon, sizeof(gTypeGroup_Dragon)/sizeof(u16)},
    {"MAP_SEVEN_ISLAND_TANOBY_RUINS_LIPTOO_CHAMBER", ENCOUNTER_LAND, gTypeGroup_Grass, sizeof(gTypeGroup_Grass)/sizeof(u16)},
    {"MAP_SEVEN_ISLAND_TANOBY_RUINS_WEEPTH_CHAMBER", ENCOUNTER_LAND, gTypeGroup_Fire, sizeof(gTypeGroup_Fire)/sizeof(u16)},
    {"MAP_SEVEN_ISLAND_TANOBY_RUINS_DILFORD_CHAMBER", ENCOUNTER_LAND, gTypeGroup_Water, sizeof(gTypeGroup_Water)/sizeof(u16)},
    {"MAP_SEVEN_ISLAND_TANOBY_RUINS_SCUFIB_CHAMBER", ENCOUNTER_LAND, gTypeGroup_Psychic, sizeof(gTypeGroup_Psychic)/sizeof(u16)},
    {"MAP_SEVEN_ISLAND_TANOBY_RUINS_RIXY_CHAMBER", ENCOUNTER_LAND, gTypeGroup_Flying, sizeof(gTypeGroup_Flying)/sizeof(u16)},
    {"MAP_SEVEN_ISLAND_TANOBY_RUINS_VIAPOIS_CHAMBER", ENCOUNTER_LAND, gTypeGroup_Normal, sizeof(gTypeGroup_Normal)/sizeof(u16)},
    {"MAP_VIRIDIAN_FOREST", ENCOUNTER_LAND, gTypeGroup_Bug, sizeof(gTypeGroup_Bug)/sizeof(u16)},
    {"MAP_MT_MOON_1F", ENCOUNTER_LAND, gTypeGroup_Ground, sizeof(gTypeGroup_Ground)/sizeof(u16)},
    {"MAP_MT_MOON_B1F", ENCOUNTER_LAND, gTypeGroup_Rock, sizeof(gTypeGroup_Rock)/sizeof(u16)},
    {"MAP_MT_MOON_B2F", ENCOUNTER_LAND, gTypeGroup_Rock, sizeof(gTypeGroup_Rock)/sizeof(u16)},
    ...
    {"MAP_DIGLETTS_CAVE_B1F", ENCOUNTER_LAND, gTypeGroup_Ground, sizeof(gTypeGroup_Ground)/sizeof(u16)},
    {"MAP_VICTORY_ROAD_1F", ENCOUNTER_LAND, gTypeGroup_Dragon, sizeof(gTypeGroup_Dragon)/sizeof(u16)},
    {"MAP_VICTORY_ROAD_2F", ENCOUNTER_LAND, gTypeGroup_Psychic, sizeof(gTypeGroup_Psychic)/sizeof(u16)},
    {"MAP_VICTORY_ROAD_3F", ENCOUNTER_LAND, gTypeGroup_Legendary, sizeof(gTypeGroup_Legendary)/sizeof(u16)},
    {"MAP_POKEMON_MANSION_1F", ENCOUNTER_LAND, gTypeGroup_Normal, sizeof(gTypeGroup_Normal)/sizeof(u16)},
    {"MAP_POKEMON_MANSION_2F", ENCOUNTER_LAND, gTypeGroup_Dragon, sizeof(gTypeGroup_Dragon)/sizeof(u16)},
    {"MAP_POKEMON_MANSION_3F", ENCOUNTER_LAND, gTypeGroup_Electric, sizeof(gTypeGroup_Electric)/sizeof(u16)},
    {"MAP_POKEMON_MANSION_B1F", ENCOUNTER_LAND, gTypeGroup_Legendary, sizeof(gTypeGroup_Legendary)/sizeof(u16)},
    ...
    {"MAP_SAFARI_ZONE_EAST", ENCOUNTER_LAND, gTypeGroup_Grass, sizeof(gTypeGroup_Grass)/sizeof(u16)},
    ...
    {"MAP_SAFARI_ZONE_NORTH", ENCOUNTER_LAND, gTypeGroup_Poison, sizeof(gTypeGroup_Poison)/sizeof(u16)},
    ...
    {"MAP_SAFARI_ZONE_WEST", ENCOUNTER_LAND, gTypeGroup_Bug, sizeof(gTypeGroup_Bug)/sizeof(u16)},
    ...
    {"MAP_CERULEAN_CAVE_2F", ENCOUNTER_LAND, gTypeGroup_Ground, sizeof(gTypeGroup_Ground)/sizeof(u16)},
    {"MAP_CERULEAN_CAVE_B1F", ENCOUNTER_LAND, gTypeGroup_Rock, sizeof(gTypeGroup_Rock)/sizeof(u16)},
    ...
    {"MAP_ROCK_TUNNEL_1F", ENCOUNTER_LAND, gTypeGroup_Rock, sizeof(gTypeGroup_Rock)/sizeof(u16)},
    {"MAP_ROCK_TUNNEL_B1F", ENCOUNTER_LAND, gTypeGroup_Rock, sizeof(gTypeGroup_Rock)/sizeof(u16)},
    {"MAP_SEAFOAM_ISLANDS_1F", ENCOUNTER_LAND, gTypeGroup_Dragon, sizeof(gTypeGroup_Dragon)/sizeof(u16)},
    {"MAP_SEAFOAM_ISLANDS_B1F", ENCOUNTER_LAND, gTypeGroup_Fighting, sizeof(gTypeGroup_Fighting)/sizeof(u16)},
    {"MAP_SEAFOAM_ISLANDS_B2F", ENCOUNTER_LAND, gTypeGroup_Fire, sizeof(gTypeGroup_Fire)/sizeof(u16)},
    {"MAP_SEAFOAM_ISLANDS_B3F", ENCOUNTER_LAND, gTypeGroup_Ground, sizeof(gTypeGroup_Ground)/sizeof(u16)},
    ...
    {"MAP_SEAFOAM_ISLANDS_B4F", ENCOUNTER_LAND, gTypeGroup_Legendary, sizeof(gTypeGroup_Legendary)/sizeof(u16)},
    ...
    {"MAP_POKEMON_TOWER_3F", ENCOUNTER_LAND, gTypeGroup_Ghost, sizeof(gTypeGroup_Ghost)/sizeof(u16)},
    {"MAP_POKEMON_TOWER_4F", ENCOUNTER_LAND, gTypeGroup_Ghost, sizeof(gTypeGroup_Ghost)/sizeof(u16)},
    {"MAP_POKEMON_TOWER_5F", ENCOUNTER_LAND, gTypeGroup_Ghost, sizeof(gTypeGroup_Ghost)/sizeof(u16)},
    {"MAP_POKEMON_TOWER_6F", ENCOUNTER_LAND, gTypeGroup_Ghost, sizeof(gTypeGroup_Ghost)/sizeof(u16)},
    {"MAP_POKEMON_TOWER_7F", ENCOUNTER_LAND, gTypeGroup_Ghost, sizeof(gTypeGroup_Ghost)/sizeof(u16)},
    {"MAP_POWER_PLANT", ENCOUNTER_LAND, gTypeGroup_Electric, sizeof(gTypeGroup_Electric)/sizeof(u16)},
    {"MAP_MT_EMBER_EXTERIOR", ENCOUNTER_LAND, gTypeGroup_Fire, sizeof(gTypeGroup_Fire)/sizeof(u16)},
    {"MAP_MT_EMBER_SUMMIT_PATH_1F", ENCOUNTER_LAND, gTypeGroup_Fire, sizeof(gTypeGroup_Fire)/sizeof(u16)},
    {"MAP_MT_EMBER_SUMMIT_PATH_2F", ENCOUNTER_LAND, gTypeGroup_Fire, sizeof(gTypeGroup_Fire)/sizeof(u16)},
    {"MAP_MT_EMBER_SUMMIT_PATH_3F", ENCOUNTER_LAND, gTypeGroup_Legendary, sizeof(gTypeGroup_Legendary)/sizeof(u16)},
    {"MAP_MT_EMBER_RUBY_PATH_1F", ENCOUNTER_LAND, gTypeGroup_Dragon, sizeof(gTypeGroup_Dragon)/sizeof(u16)},
    {"MAP_MT_EMBER_RUBY_PATH_B1F", ENCOUNTER_LAND, gTypeGroup_Fire, sizeof(gTypeGroup_Fire)/sizeof(u16)},
    {"MAP_MT_EMBER_RUBY_PATH_B2F", ENCOUNTER_LAND, gTypeGroup_Fire, sizeof(gTypeGroup_Fire)/sizeof(u16)},
    {"MAP_MT_EMBER_RUBY_PATH_B3F", ENCOUNTER_LAND, gTypeGroup_Dragon, sizeof(gTypeGroup_Dragon)/sizeof(u16)},
    {"MAP_MT_EMBER_RUBY_PATH_B1F_STAIRS", ENCOUNTER_LAND, gTypeGroup_Fire, sizeof(gTypeGroup_Fire)/sizeof(u16)},
    ...
    {"MAP_ROUTE2", ENCOUNTER_LAND, gTypeGroup_Flying, sizeof(gTypeGroup_Flying)/sizeof(u16)},
    {"MAP_ROUTE3", ENCOUNTER_LAND, gTypeGroup_Grass, sizeof(gTypeGroup_Grass)/sizeof(u16)},
    {"MAP_ROUTE4", ENCOUNTER_LAND, gTypeGroup_Poison, sizeof(gTypeGroup_Poison)/sizeof(u16)},
    ...
    {"MAP_ROUTE5", ENCOUNTER_LAND, gTypeGroup_Ground, sizeof(gTypeGroup_Ground)/sizeof(u16)},
    {"MAP_ROUTE6", ENCOUNTER_LAND, gTypeGroup_Electric, sizeof(gTypeGroup_Electric)/sizeof(u16)},
    ...
    {"MAP_ROUTE7", ENCOUNTER_LAND, gTypeGroup_Fire, sizeof(gTypeGroup_Fire)/sizeof(u16)},
    {"MAP_ROUTE8", ENCOUNTER_LAND, gTypeGroup_Grass, sizeof(gTypeGroup_Grass)/sizeof(u16)},
    {"MAP_ROUTE9", ENCOUNTER_LAND, gTypeGroup_Water, sizeof(gTypeGroup_Water)/sizeof(u16)},
    ...
    {"MAP_ROUTE11", ENCOUNTER_LAND, gTypeGroup_Bug, sizeof(gTypeGroup_Bug)/sizeof(u16)},
    ...
    {"MAP_ROUTE12", ENCOUNTER_LAND, gTypeGroup_Electric, sizeof(gTypeGroup_Electric)/sizeof(u16)},
    ...
    {"MAP_ROUTE13", ENCOUNTER_LAND, gTypeGroup_Psychic, sizeof(gTypeGroup_Psychic)/sizeof(u16)},
    ...
    {"MAP_ROUTE14", ENCOUNTER_LAND, gTypeGroup_Dragon, sizeof(gTypeGroup_Dragon)/sizeof(u16)},
    {"MAP_ROUTE15", ENCOUNTER_LAND, gTypeGroup_Poison, sizeof(gTypeGroup_Poison)/sizeof(u16)},
    {"MAP_ROUTE16", ENCOUNTER_LAND, gTypeGroup_Flying, sizeof(gTypeGroup_Flying)/sizeof(u16)},
    {"MAP_ROUTE17", ENCOUNTER_LAND, gTypeGroup_Ground, sizeof(gTypeGroup_Ground)/sizeof(u16)},
    {"MAP_ROUTE18", ENCOUNTER_LAND, gTypeGroup_Psychic, sizeof(gTypeGroup_Psychic)/sizeof(u16)},
    ...
    {"MAP_ROUTE21_NORTH", ENCOUNTER_LAND, gTypeGroup_Dragon, sizeof(gTypeGroup_Dragon)/sizeof(u16)},
    ...
    {"MAP_ROUTE22", ENCOUNTER_LAND, gTypeGroup_Fighting, sizeof(gTypeGroup_Fighting)/sizeof(u16)},
    ...
    {"MAP_ROUTE23", ENCOUNTER_LAND, gTypeGroup_Dragon, sizeof(gTypeGroup_Dragon)/sizeof(u16)},
    ...
    {"MAP_ROUTE24", ENCOUNTER_LAND, gTypeGroup_Psychic, sizeof(gTypeGroup_Psychic)/sizeof(u16)},
    ...
    {"MAP_ROUTE25", ENCOUNTER_LAND, gTypeGroup_Grass, sizeof(gTypeGroup_Grass)/sizeof(u16)},
    ...
    {"MAP_SIX_ISLAND_ALTERING_CAVE", ENCOUNTER_LAND, gTypeGroup_Legendary, sizeof(gTypeGroup_Legendary)/sizeof(u16)},
    {"MAP_SIX_ISLAND_ALTERING_CAVE", ENCOUNTER_LAND, gTypeGroup_Legendary, sizeof(gTypeGroup_Legendary)/sizeof(u16)},
    {"MAP_SIX_ISLAND_ALTERING_CAVE", ENCOUNTER_LAND, gTypeGroup_Legendary, sizeof(gTypeGroup_Legendary)/sizeof(u16)},
    {"MAP_SIX_ISLAND_ALTERING_CAVE", ENCOUNTER_LAND, gTypeGroup_Legendary, sizeof(gTypeGroup_Legendary)/sizeof(u16)},
    {"MAP_SIX_ISLAND_ALTERING_CAVE", ENCOUNTER_LAND, gTypeGroup_Legendary, sizeof(gTypeGroup_Legendary)/sizeof(u16)},
